...
class PancakeswapV2LP(UniswapV2LP):
    ...
    def __init__(self, address: Union[str, Address], token0: RToken, token1: RToken, reserves0: Optional[int] = None, reserves1: Optional[int] = None):
        ...
        self.fees_as_fraction: Tuple[int, int] = (9975, 10000)
    ...
    def to_json(self) -> str:
        return json.dumps({
            ...
            "type": "PancakeswapV2LP"
        })


def pancake_v2_from_json(json_str: str) -> PancakeswapV2LP:
    obj_dict = json.loads(json_str)
    return PancakeswapV2LP(Address(obj_dict["address"]),
