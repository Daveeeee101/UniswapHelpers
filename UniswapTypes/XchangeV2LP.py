...
class XchangeV2LP(UniswapV2LP):
    ...
    def __init__(self, address: Union[str, Address], token0: RToken, token1: RToken, reserves0: Optional[int] = None, reserves1: Optional[int] = None):
        ...
        self.fees_as_fraction = (100000 - 200, 100000)
...
def xchange_v2_from_json(json_str: str) -> XchangeV2LP:
    obj_dict = json.loads(json_str)
    return XchangeV2LP(Address(obj_dict["address"]),
